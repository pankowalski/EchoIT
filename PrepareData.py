...
class PrepareData:
    def __init__(self):
        self.host = st.secrets.server.host
        self.port = st.secrets.server.port
        self.db_name = st.secrets.server.db_name
        self.collection_name = st.secrets.server.collection_name
